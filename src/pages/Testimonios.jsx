...
export default function Testimonios() {
  ...
  return (
    <>
      <Helmet>
        <title>Testimonios | Tesis de Derecho Aprobadas – Iuris Prima</title>
        <meta name="description" content="Lee los testimonios de egresados que aprobaron su tesis de Derecho con Iuris Prima en Huancayo. 98% de tasa de aprobación." />
        <link rel="canonical" href="https://iurisprima.com/testimonios" />
      </Helmet>
        ...
        <section className="px-4 sm:px-8 lg:px-14 py-16 sm:py-20 lg:py-24">
          <div className="max-w-[1160px] mx-auto">
            ...
            {testimonios.length > 0 ? (
              <div
                className="grid gap-px bg-white/[0.04] mb-16 sm:mb-20"
                style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}
              >
                {testimonios.map((t) => (
                  <div
                    key={t.id}
                    className="reveal bg-[#0A0C12] p-8 sm:p-10 lg:p-12 relative transition-colors duration-300 hover:bg-[#0f1219]"
                  >
                    <div className="absolute top-5 left-8 font-serif text-[5rem] text-[#F0C060]/[0.06] leading-none select-none">
                      "
                    </div>
                    <div className="flex gap-0.5 mb-4 sm:mb-5 relative z-[1]">
                      {ESTRELLAS.map(s => (
                    ...
                    <p className="font-serif text-[0.98rem] sm:text-[1.05rem] italic leading-[1.8] text-white/90 mb-6 sm:mb-7 relative z-[1]">
                      "{t.texto}"
                    </p>
                    <div className="border-t border-[#F0C060]/10 pt-4 sm:pt-5">
                      <div className="text-[0.72rem] tracking-[3px] uppercase text-[#F0C060] mb-1">
                        {t.nombre}
                      </div>
                      <div className="text-[0.72rem] sm:text-[0.75rem] text-white/35">
                        {t.carrera} · {t.fecha}
                      </div>
                    </div>
                  </div>
              ...
              <div className="reveal text-center py-16 sm:py-20 px-6 sm:px-10 border border-[#F0C060]/10 mb-16 sm:mb-20">
                ...
                <p className="font-serif text-xl sm:text-2xl italic text-white/35 mb-3">
            ...
            {/* FORMULARIO */}
            <div className="reveal bg-[#F0C060]/[0.03] border border-[#F0C060]/15 p-7 sm:p-10 lg:p-16">
              <p className="text-[0.62rem] tracking-[6px] uppercase text-[#F0C060]/60 mb-4">
                Deja tu reseña
              </p>
              <h2
                className="font-serif font-bold text-white leading-[1.1] mb-2"
                style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)' }}
              >
                ¿Trabajaste con{' '}
                <em className="italic text-[#F0C060]">nosotros?</em>
              </h2>
              <p className="text-[0.85rem] font-light leading-[1.8] text-white/45 mb-10 sm:mb-12">
              ...
              {enviado ? (
                <div className="text-center py-10 sm:py-12 px-6 sm:px-10 border border-[#F0C060]/20 bg-[#F0C060]/[0.05]">
                  ...
                  <p className="font-serif text-xl sm:text-2xl italic text-[#F0C060] mb-2">
                  ...
                  <button
                    ...
                    className="bg-transparent border border-[#F0C060]/30 text-[#F0C060]/60 px-6 py-2.5 text-[0.72rem] tracking-[3px] uppercase cursor-pointer rounded-sm transition-colors duration-200 hover:border-[#F0C060] hover:text-[#F0C060]"
                  >
                    Dejar otra reseña
                  </button>
                </div>
                ...
                <div>
                  ...
                  {/* Nombre + Carrera — apilados en móvil */}
                  ...
                  <button
                    ...
                    disabled={!isValid}
                    className={`w-full sm:w-auto px-10 sm:px-12 py-4 text-[0.78rem] font-medium tracking-[4px] uppercase border-none rounded-sm transition-all duration-200 ${
                      isValid
