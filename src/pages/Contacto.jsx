...
export default function Contacto() {
  ...
  return (
    <>
      <Helmet>
        <title>Contacto | Iuris Prima – Asesoría Tesis de Derecho Huancayo</title>
        <meta name="description" content="Contáctanos para una consulta gratuita sobre tu tesis de Derecho. Atención por WhatsApp y presencial en Huancayo, Junín, Perú." />
        <link rel="canonical" href="https://iurisprima.com/contacto" />
      </Helmet>
