  ...
  return (
    <>
      ...
      <main className="bg-[#0A0C12] min-h-screen pt-24 relative z-[1]">
        ...
        <section className="px-15 py-20 border-b border-[#F0C060]/10">
          <div className="max-w-[1160px] mx-auto">
            ...
            <div className="grid grid-cols-2 gap-20 items-center">
              <div>
                <h1 className="reveal font-serif font-bold text-white leading-[1.05] mb-8"
                  style={{ fontSize: 'clamp(2.2rem, 4vw, 3.8rem)' }}>
                  Nacimos para ayudar a los{' '}
                  <em className="italic text-[#F0C060]">profesionales del derecho</em>{' '}
                  a titularse.
                </h1>
                <p className="reveal text-[0.95rem] font-light leading-[2] text-white/60 mb-6">
                ...
                <p className="reveal text-[0.95rem] font-light leading-[2] text-white/60">
              ...
              <div className="reveal bg-[#F0C060]/[0.05] border border-[#F0C060]/20 p-12">
                <div className="font-serif text-[5rem] text-[#F0C060]/15 leading-none mb-6">
                  +200
                </div>
                <p className="font-serif text-2xl italic text-[#F0C060] mb-4">
        ...
        {/* EQUIPO */}
        <section className="px-15 py-24 border-b border-[#F0C060]/10">
          <div className="max-w-[1160px] mx-auto">
            <p className="reveal text-[0.62rem] tracking-[6px] uppercase text-[#F0C060]/60 mb-5">
              El equipo
            </p>
            <h2 className="reveal font-serif font-bold text-white leading-[1.1] mb-16"
              style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)' }}>
              Respaldo <em className="italic text-[#F0C060]">profesional</em>
            </h2>

            <div className="grid grid-cols-3 gap-[2px] bg-white/[0.04]">
              <div className="reveal bg-[#0A0C12] p-10 transition-colors duration-300 hover:bg-[#0f1219]">
                <div className="mb-5">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#F0C060" strokeWidth="1.5">
                ...
                <p className="text-[0.85rem] font-light leading-[1.8] text-white/55">
                  Nuestro equipo está conformado exclusivamente por abogados colegiados con formación académica de posgrado y experiencia en investigación jurídica.
                </p>
              </div>
              ...
              <div className="reveal bg-[#0A0C12] p-10 transition-colors duration-300 hover:bg-[#0f1219]">
                ...
                <p className="text-[0.85rem] font-light leading-[1.8] text-white/55">
                  Cada tesis es revisada por más de un especialista. Nunca trabajas con una sola persona — trabajas con un equipo que revisa, discute y mejora cada entrega.
                </p>
              </div>
              ...
              <div className="reveal bg-[#0A0C12] p-10 transition-colors duration-300 hover:bg-[#0f1219]">
                ...
                <p className="text-[0.85rem] font-light leading-[1.8] text-white/55">
                  Conocemos los reglamentos, estándares y exigencias específicas de las facultades de Derecho de Huancayo y la región Junín.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="px-15 py-24">
          <div className="max-w-[1160px] mx-auto">
            ...
            <div className="grid grid-cols-2 gap-[2px] bg-white/[0.04]">
              {VALORES.map((v, i) => (
                <div key={i} className="reveal bg-[#0A0C12] p-12 transition-colors duration-300 hover:bg-[#0f1219]">
                  <div className="mb-5">{v.icon}</div>
                  <h3 className="font-serif text-xl font-bold text-white mb-3.5">
                    {v.title}
                  </h3>
                  <p className="text-[0.88rem] font-light leading-[1.9] text-white/55">
                    {v.desc}
                  </p>
                </div>
              ))}
